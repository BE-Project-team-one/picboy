...
@Getter
@NoArgsConstructor
public class PostMainTop410ResponseDto {
    ...
    public PostMainTop410ResponseDto(Long id, String gifUrl, int likeCount, String topic, String username, int memberCount) {
        this.id = id;
        this.gifUrl = gifUrl;
